		...
		<nav class="navbar navbar-default " role="navigation">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="patient.php"><img alt="Brand" src="assets/img/logod.jpg" height="35px"></a>
				</div>
					...
					<div class="row">
						<div class="col-md-3 col-sm-3">
							...
							<div class="user-wrapper">
								<img src="assets/img/helth.jpg" class="img-responsive" />
								<div class="description">
									<h4><p>Hello! </p><?php echo $userRow['patientFirstName']; ?> <?php echo $userRow['patientLastName']; ?></h4>
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 class="modal-title" id="myModalLabel">Update Prifile</h4>
									</div>
